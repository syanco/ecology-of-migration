...
(ndvi_mod_mu_df <- data.frame(param = rep("mu", 4),
                          ...
                          season = sub("season", "", ndvi_mod_mu_df$row_names)
                          ))
...
(ndvi_mod_var_df <- data.frame(param = rep("var", 4),
                          ...
                          season = sub("phi_season", "", ndvi_mod_var_df$row_names)
                          ))
...
fm_mef <- gam(TMIN ~ s(doy), data = mef_temp)
fm_hc <- gam(TMIN ~ s(doy), data = hc_temp)
